...
- [x] Explain what a token is used for.
  ...
  An authentication token is generated by the server and set to the client on successful login.
  It is used to determine whether a user is auntheticated and can be allowed access to various portions
  of the app.

- [x] What steps can you take in your web apps to keep your data secure?

  - Encrypt site data
  - Communicate securely via HTTPS
  - Use Authentication to determine access to site resources

- [x] Describe how web servers work.

  Web servers receive a request from a client (browser, cli etc), parse it and return a response based
